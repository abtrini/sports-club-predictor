...
export default async function LoginPage({
  ...
  const nextPath = next?.startsWith("/") && !next.startsWith("//") ? next : "/predictions";
  ...
  return (
    <section className="page-width narrow page-top section-block">
      <div className="content-card">
        ...
        <h1>Sign in</h1>
        <p>Players can enter predictions. Approved administrators can manage the competition.</p>
        ...
        <p className="form-footnote">
          New player? <Link href="/register">Register for the 20-person league.</Link>
        </p>
      </div>
    </section>
  );
