...
export default async function PredictionsPage({
    ...
    return (
      <section className="page-width page-top section-block">
        <div className="content-card">
          ...
          <p>Configure the database using README.md to enable registration and predictions.</p>
        </div>
      </section>
    );
  }
  ...
  if (!user) redirect("/login?message=Sign%20in%20to%20enter%20your%20predictions.&next=%2Fpredictions");
    ...
    return (
      <section className="page-width narrow page-top section-block">
        <div className="content-card">
          ...
          <p>
            Your account is signed in, but it is not connected to an active place in the 20-person table.
            Ask an administrator to link or add you.
          </p>
  ...
  const [fixtures, { data: predictionRows }] = await Promise.all([
    ...
    supabase
      .from("predictions")
      .select("id, fixture_id, predicted_home_score, predicted_away_score, submitted_at, updated_at")
  ...
  return (
    <section className="page-width page-top section-block">
      ...
      <div className="notice">
        <strong>Automatic lock:</strong> every prediction closes exactly 15 minutes before kickoff. Late entries are rejected by the database.
      </div>
      ...
      <div className="prediction-grid">
        {fixtures.length > 0 ? (
          ...
          <div className="content-card"><p>No fixtures have been selected yet.</p></div>
        )}
      </div>
    </section>
  );
