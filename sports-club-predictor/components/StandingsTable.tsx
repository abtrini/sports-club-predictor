  ...
  return (
    <div className="table-shell">
      <div
        ...
        aria-label="Standings colour legend"
      >
        <span>
          <i className="legend-dot promoted" /> Top four
        </span>
        <span>
          <i className="legend-dot relegated" /> Bottom five
        </span>
      </div>
        ...
        <table className="standings-table">
          ...
          <tbody>
            {standings.map((participant, index) => {
              ...
              const isRelegated =
                total >= 9 && position > total - 5;

              const rowClass = isPromoted
                ? "row-promoted"
                : isRelegated
                  ? "row-relegated"
                  : "";
              ...
              const initials =
                participant.shortName?.slice(0, 2) ||
                ...
                <tr key={participant.id} className={rowClass}>
                  ...
                  <td>
                    <Link
                      ...
                      aria-label={`View ${participant.name}'s player statistics`}
                    >
